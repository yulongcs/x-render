...
export default () => <FR schema={expression} />;`},"demo/FR.jsx":{import:"./demo/FR",content:$},"json/schema.js":{import:"./json/schema",content:p}},dependencies:{react:{version:">=16.8.0"},"form-render":{version:"1.1.3"},antd:{version:"4.x",css:"antd/dist/antd.css"},"react-dom":{version:">=16.8.0"}},identifier:"function-demo-1"}},"watch-demo":{component:Object(D.dynamic)({loader:function(){var g=Object(S.a)(o.a.mark(function h(){var l,t,m,i,f,n,s,r,y;return o.a.wrap(function(d){for(;;)switch(d.prev=d.next){case 0:return l=e("3PQu"),t=e("K+nK"),d.next=4,e.e(3).then(e.t.bind(null,"MaXC",7));case 4:return d.t0=t,d.next=7,e.e(12).then(e.t.bind(null,"4IMT",7));case 7:return d.t1=d.sent,m=(0,d.t0)(d.t1),d.t2=t,d.next=12,Promise.resolve().then(e.t.bind(null,"q1tI",7));case 12:return d.t3=d.sent,i=(0,d.t2)(d.t3),d.next=16,Promise.all([e.e(0),e.e(1),e.e(2),e.e(11),e.e(13)]).then(e.bind(null,"gdfu"));case 16:return f=d.sent,d.t4=l,d.next=20,Promise.all([e.e(0),e.e(1),e.e(2),e.e(3),e.e(8)]).then(e.bind(null,"refC"));case 20:return d.t5=d.sent,n=(0,d.t4)(d.t5),s={type:"object",properties:{input1:{title:"\u7B80\u5355\u8F93\u5165\u6846",type:"string",required:!0},input2:{title:"\u7B80\u5355\u8F93\u5165\u68462",type:"string"}}},r=function(){var L=(0,n.useForm)(),a=function(Y,Z){Z.length>0?alert("errorFields:"+JSON.stringify(Z)):alert("formData:"+JSON.stringify(Y,null,2))},b={"#":function(Y){console.log("\u8868\u5355\u7684\u65F6\u65F6\u6570\u636E\u4E3A\uFF1A",Y)},input1:function(Y){Y!==void 0&&L.onItemChange("input2",Y)}};return i.default.createElement("div",null,i.default.createElement(n.default,{form:L,schema:s,onFinish:a,watch:b}),i.default.createElement(m.default,{type:"primary",onClick:L.submit},"\u63D0\u4EA4"))},y=r,d.abrupt("return",y);case 26:case"end":return d.stop()}},h)}));function v(){return g.apply(this,arguments)}return v}()}),previewerProps:{sources:{_:{jsx:`import React from 'react';
import { Button } from 'antd';
import FormRender, { useForm } from 'form-render';
